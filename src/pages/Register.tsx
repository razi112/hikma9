...
const Register = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast.info("Registration requires Lovable Cloud. Enable it to proceed!");
    }, 800);
  };
    ...
    <div className="min-h-screen gradient-navy flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-card rounded-xl shadow-2xl p-8 animate-scale-in">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-bold text-foreground">Join Hikma</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <Input id="firstName" placeholder="Ahmed" required className="mt-1" />
            </div>
            <div>
              <Label htmlFor="lastName">Last Name</Label>
              <Input id="lastName" placeholder="Ibrahim" required className="mt-1" />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <Input id="gradYear" type="number" placeholder="2026" required className="mt-1" />
          </div>
          <div>
